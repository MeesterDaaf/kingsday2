        ...
        <div class="max-w-md w-full space-y-8">
            <div class="bg-white shadow-md rounded-lg p-6 mb-8">
                <div class="text-center">
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">Huidig aantal voorspellingen</h3>
                    <p class="text-4xl font-extrabold text-orange-600">{{ App\Models\Prediction::count() }}</p>
                    <p class="mt-4 text-lg text-gray-600">Totaal opgehaald:</p>
                    <p class="text-2xl font-bold text-orange-600">
                        €{{ number_format(App\Models\Prediction::count() * 0.5, 2, ',', '.') }}</p>
                </div>
            </div>
